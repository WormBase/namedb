 ...
 (when-not *compile-files*
  [{:db/id (tempid :db.part/user -2001)
   ...
   {:db/id (tempid :db.part/user)
    :name-type/domain (tempid :db.part/user -2001)
    :name-type/name "CGC"
   ...
   {:db/id (tempid :db.part/user)
    :name-type/domain (tempid :db.part/user -2003)
    :name-type/name "Public_name"
    :name-type/unique true
    :name-type/primary true}
